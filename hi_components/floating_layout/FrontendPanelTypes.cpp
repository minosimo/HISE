...
var PresetBrowserPanel::toDynamicObject() const
{
  ...
  storePropertyInObject(obj, SpecialPanelIds::ShowFavoritesOnly, options.showFavoritesOnly);
...
void PresetBrowserPanel::fromDynamicObject(const var& object)
{
  ...
  options.showFavoritesOnly = getPropertyWithDefault(object, SpecialPanelIds::ShowFavoritesOnly);
...
juce::Identifier PresetBrowserPanel::getDefaultablePropertyId(int index) const
{
  ...
  RETURN_DEFAULT_PROPERTY_ID(index, SpecialPanelIds::ShowFavoritesOnly, "ShowFavoritesOnly");
...
var PresetBrowserPanel::getDefaultProperty(int index) const
{
  ...
  RETURN_DEFAULT_PROPERTY(index, SpecialPanelIds::ShowFavoritesOnly, false);
